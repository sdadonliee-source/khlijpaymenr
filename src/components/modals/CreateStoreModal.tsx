...
export default function CreateStoreModal({ isOpen, onClose, onSave, loading }: Props) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-md z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <h3 className="text-3xl font-bold mb-2 tracking-tight">Create Store</h3>
        <p className="text-zinc-500 text-sm mb-8">Fill in the details for your new store</p>
