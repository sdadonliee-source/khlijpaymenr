export const GCC_COUNTRIES = {
  SA: { 
    ...
    paymentMethods: { EN: ['Mada', 'STC Pay', 'urpay', 'Al Rajhi Bank', 'SNB', 'Visa/Mastercard', 'Crypto (Bitcart)'], AR: ['مدى', 'إس تي سي باي', 'يورباي', 'مصرف الراجحي', 'البنك الأهلي السعودي', 'فيزا/ماستركارد', 'كريبتو (Bitcart)'] },
    methodsDetails: [
      ...
      { id: 'bitcart', name: { EN: 'Crypto (Bitcart)', AR: 'كريبتو (Bitcart)' }, type: 'wallet' }
    ]
  },
  AE: { 
    name: { EN: 'UAE', AR: 'الإمارات' }, 
    currency: { EN: 'AED', AR: 'د.إ' }, 
    paymentMethods: { EN: ['Apple Pay', 'Payit', 'Emirates NBD', 'FAB', 'Visa/Mastercard', 'Crypto (Bitcart)'], AR: ['Apple Pay', 'Payit', 'بنك الإمارات دبي الوطني', 'بنك أبوظبي الأول', 'فيزا/ماستركارد', 'كريبتو (Bitcart)'] },
    methodsDetails: [
  ...
  QA: { 
    ...
    paymentMethods: { EN: ['NAPS', 'Apple Pay', 'Google Pay', 'QNB', 'Visa/Mastercard', 'Crypto (Bitcart)'], AR: ['NAPS', 'Apple Pay', 'Google Pay', 'بنك قطر الوطني', 'فيزا/ماستركارد', 'كريبتو (Bitcart)'] },
    methodsDetails: [
  ...
  BH: { 
    ...
    paymentMethods: { EN: ['BenefitPay', 'Benefit', 'BBK', 'NBB', 'Visa/Mastercard', 'Crypto (Bitcart)'], AR: ['بنفت باي', 'بنفت', 'بنك البحرين والكويت', 'بنك البحرين الوطني', 'فيزا/ماستركارد', 'كريبتو (Bitcart)'] },
    methodsDetails: [
  ...
  KW: { 
    ...
    paymentMethods: { EN: ['K-Net', 'Apple Pay', 'NBK', 'KFH', 'Visa/Mastercard', 'Crypto (Bitcart)'], AR: ['كي نت', 'Apple Pay', 'بنك الكويت الوطني', 'بيت التمويل الكويتي', 'فيزا/ماستركارد', 'كريبتو (Bitcart)'] },
    methodsDetails: [
  ...
  OM: { 
    ...
    paymentMethods: { EN: ['OmanNet', 'Thawani Pay', 'Bank Muscat', 'NBO', 'Visa/Mastercard', 'Crypto (Bitcart)'], AR: ['عمان نت', 'ثواني باي', 'بنك مسقط', 'البنك الوطني العماني', 'فيزا/ماستركارد', 'كريبتو (Bitcart)'] },
    methodsDetails: [
